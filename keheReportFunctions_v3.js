...
function ohOoFormat() {
  ...
  s.autoResizeColumns(8, 26);
  s.setColumnWidth(13, 100);
  s.setColumnWidths(15, 3,80);
  s.setColumnWidths(18, 2, 100);
  s.setColumnWidths(20, 2, 75);
  s.setColumnWidth(23, 70);
...
function promoFormat() {
  ...
  s.setColumnWidth(4, 70);
  s.setColumnWidth(7, 180);
  s.autoResizeColumns(8, 18);
  s.setColumnWidth(13, 100);
  s.setColumnWidths(15, 3, 70);
  s.setColumnWidths(18, 2, 80);
  s.setColumnWidths(20, 2,70);
  s.setColumnWidths(20, 2, 75);
  s.setColumnWidth(22, 70);
